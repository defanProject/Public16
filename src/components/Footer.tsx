      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center space-y-8">
          ...
          <div className="w-full border-t border-gray-800 pt-8 flex flex-col items-center space-y-4">
            <p className="text-gray-400 text-[10px] font-bold uppercase tracking-widest text-center max-w-2xl leading-relaxed">
              {t('common.disclaimer')}
            </p>
            <div className="flex flex-col md:flex-row justify-between items-center w-full space-y-4 md:space-y-0 pt-4">
              <p className="text-gray-400 text-xs">
                © {new Date().getFullYear()} SnapTok.lol. {t('common.allRightsReserved')}
              </p>
              <div className="flex space-x-6">
                <span className="text-gray-400 text-xs">{t('common.footerText')}</span>
              </div>
            </div>
          </div>
        </div>
